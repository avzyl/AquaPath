...
let NthnStLine = L.polyline(ConstantsNthnStCoord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
...
let DCSt1Line =  L.polyline(DCSt1Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt2Line =  L.polyline(DCSt2Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt3Line =  L.polyline(DCSt3Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt4Line =  L.polyline(DCSt4Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt5Line =  L.polyline(DCSt5Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt6Line =  L.polyline(DCSt6Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt7Line =  L.polyline(DCSt7Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt8Line =  L.polyline(DCSt8Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt9Line =  L.polyline(DCSt9Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt10Line =  L.polyline(DCSt10Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt11Line =  L.polyline(DCSt11Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt12Line =  L.polyline(DCSt12Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt13Line =  L.polyline(DCSt13Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt14Line =  L.polyline(DCSt14Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt15Line =  L.polyline(DCSt15Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt16Line =  L.polyline(DCSt16Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt17Line =  L.polyline(DCSt17Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt18Line =  L.polyline(DCSt18Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt19Line =  L.polyline(DCSt19Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
let DCSt20Line =  L.polyline(DCSt20Coord, { color: 'green', opacity: 0.6, weight: 5 }).addTo(map);
// intial water lvles
